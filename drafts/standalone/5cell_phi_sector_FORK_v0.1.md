...
> 本文書は `比較射σの統一定理_v0.1.md` v0.3.1 §3.3.bis (φ-sector 予告) から分岐した FORK 文書である。
...
**ただし next steps への制約**: 次に σ 論文本流 (`比較射σの統一定理_v0.1.md` v0.3.1) に触る際、または忘却論 13 論文の核主張・記号・Paper VIII α-filtration の定式化に触る際は、NLM 3-query 徹底 (yugaku-notebook-sourcing Layer 1) を必須とする。D3 (automath issue 起票) や D1 (σ 論文 ledger 更新) がこの制約に該当する。
