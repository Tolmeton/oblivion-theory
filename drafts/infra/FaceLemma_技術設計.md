...
**v0.2 (2026-04-17)**
**型**: technical design / proof support
**昇格先**: `calculations/`, appendix, `drafts/リファレンス/FaceLemma.md`
**failure condition**: syndrome / detectability / recoverability の三層が分離できず、Face Lemma 本体の読者向け定義だけで足りる場合は補助設計へ降格し、本文へは戻さない。
...
**reader-facing**: `drafts/リファレンス/FaceLemma.md`
...
忘却論の $U_n$ は、主要な読解では「値を反転する」より「構造を落として定義域を痩せさせる」作用である。
