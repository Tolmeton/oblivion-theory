...
**対象論文**: `/home/makaron8426/Sync/oikos/oblivion-theory/drafts/series/論文XI_プロンプトは忘却である_草稿.md`
...
1. **共通 HGK context を外す**
   Agent 環境ではなく、条件プロンプトのみを渡す API / CLI single-shot で実行する。
...
- OpenAI または open-weight 系: 第 3 family
