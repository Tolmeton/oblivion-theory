...
**型**: draft embryo / seed bag
**昇格先**: `Face5Lemma_draft.md` / 5-cell satellite draft / σ 統一論文 appendix
**failure condition**: 種が Face5 / σ / 5-cell のいずれの検証課題にも接続せず、数値一致や図形類比だけに留まる場合は seed bag 内で保持し、本流へ送らない。
