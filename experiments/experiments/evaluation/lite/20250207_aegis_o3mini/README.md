...
[Aegis](https://github.com/evandiewald/aegis) is a side project that I'm using as a learning opportunity to get hands-on with applications of agents for software engineering. It is significantly inspired by [Moatless Tools](https://github.com/aorwall/moatless-tools), whose incredibly helpful code & experiments have helped me overcome a number of technical challenges. I'm hoping to use this as a jumping-off point for more novel experiments.
